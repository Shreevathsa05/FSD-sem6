...
public class BookIssueController {
    ...
    public ResponseEntity<BookIssueResponseDTO> create(@Valid @RequestBody BookIssueRequestDTO dto) {
    ...
    @PutMapping("/{id}")
    @PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<BookIssueResponseDTO> update(@PathVariable Long id, @Valid @RequestBody BookIssueRequestDTO dto) {
